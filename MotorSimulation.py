...
class MotorSimulation:
    ...
    def payload(self,devicename,date):
        ...
        #p|80|b|50|t|85
        self.velocidad = random.uniform(5, 100)
        self.sonido = random.uniform(1, 50)
        self.temperatura = random.uniform(1, 50)
        self.vibracionh = random.uniform(1, 10);
        self.vibracionv = random.uniform(1, 10);
        payloadStr = "n|"+devicename+"|v|"+str("{0:.2f}".format(self.velocidad))+"|s|"+str("{0:.2f}".format(self.sonido))+"|t|"+str("{0:.2f}".format(self.temperatura))+"|d|"+str(ahora)
